  ...
  return (
    <div className="py-32 px-6 text-white max-w-4xl mx-auto">
      ...
      <div className="bg-gray-800/40 p-8 rounded-2xl border border-gray-700 mb-10">
        ...
        <p className="text-gray-300 mt-2">Email: user@example.com</p>
        <p className="text-gray-300 mt-1">Wallet: 0x1234...abcd</p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {[1, 2, 3].map((id) => (
          <div
            key={id}
            className="bg-gray-800/40 rounded-xl border border-gray-700 p-4 shadow hover:border-indigo-500 transition"
          >
            <img
              src={`https://picsum.photos/300?my=${id}`}
